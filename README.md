...
- 🎯 **11 Pre-configured Themes**: Including Catppuccin, Gruvbox, TokyoNight, Nord, and more
...
- 🎵 **Media & Audio**: Full audio stack with Pipewire and media controls
...
- **pywal**: Terminal and application theming
- **pywalfox**: Firefox theme integration
- 11 pre-configured color schemes in `/themes` directory
...
- `sokratos-next-theme`: Cycle to the next theme
...
- `sokratos-cheat-sheet`: Quick reference guide
- `sokratos-switch-nvim`: Switch Neovim configurations
- `sokratos-wf-recorder`: Screen recording helper
- `tmux-sessionizer`: Smart tmux session management
- `brain-sort`: Custom organization tool
...
The current theme is symlinked at:
- `~/.config/sokratos/current/theme/colors.conf`
- `~/.config/sokratos/current/theme/ghostty-colors`
...
- Inspired by the Linux ricing community
